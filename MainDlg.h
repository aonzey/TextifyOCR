...
public:
	...
	BEGIN_MSG_MAP_EX(CMainDlg)
		...
		COMMAND_ID_HANDLER_EX(IDC_OCR, OnOcrButton)
		...
		MESSAGE_HANDLER_EX(UWM_OCR_CAPTURE_COMPLETE, OnOcrCaptureComplete)
	END_MSG_MAP()
	...
	LRESULT OnOcrCaptureComplete(UINT uMsg, WPARAM wParam, LPARAM lParam);
...
private:
	...
	UINT m_uTextifyMsg = RegisterWindowMessage(L"TextifyOCR");
