...
public:
	...
	// Constructor for OCR mode: text is provided directly
	CTextDlg(const UserConfig& config, const CString& ocrText, CPoint ptPos) :
		m_wndEdit(this, 1),
		m_config(config),
		m_ocrText(ocrText),
		m_ocrPoint(ptPos),
...
private:
	...
	CString m_ocrText;
	CPoint m_ocrPoint{ 0, 0 };
	bool m_hasOcrText = false;
